...
import 'package:mobeasy_task/bloc/quiz_data/quiz_data_bloc.dart';
import 'package:mobeasy_task/bloc/quiz_data/quiz_data_state.dart';
import 'package:mobeasy_task/data/repositories/quiz_repo.dart';
import 'package:mobeasy_task/presentation/main/question_screen.dart';
import 'package:mobeasy_task/utility/category_detail_list.dart';
...
class PrepareQuizScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print(
        'https://the-trivia-api.com/api/questions?categories=${categoryDetailList[index].category}&limit=10&difficulty=$selectedDif');
